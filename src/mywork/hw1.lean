...
Given objects x, y, z, and w of some type T, and assuming x = y, y = z, 
and w = z we can prove z = w. Since w = z, by the symmetirc property 
of equality we know z = w.
QED
-/
...
Assume you are given an arbritary object of that type
-/
